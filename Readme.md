...
Bottles Ping connects people who want to recycle ("pinners") with local collectors who can pick up bottles for 
cash. Built with **React Native (Expo)** for the frontend and **Flask + AWS ECS + RDS + S3** for the backend.
